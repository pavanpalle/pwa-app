...
export const useComparableStyles = (props = {}) => {
    ...
    const { getStoreConfigData, getComparableProductsQuery,getComparableProductsWithoutPriceQuery } = operations;
    const { pathname } = useLocation();
 const productsQuery = isSignedIn?getComparableProductsQuery:getComparableProductsWithoutPriceQuery
