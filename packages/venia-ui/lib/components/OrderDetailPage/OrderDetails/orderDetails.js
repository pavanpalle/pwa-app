...
import CompanyInformation from './companynformation';
    ...
    return (
        <div className={classes.root}>
            <div className={classes.shippingInformationContainer}>
                <CompanyInformation data={orderData} />
            </div>
            <div className={classes.shippingMethodContainer}>
                <ConditionalWrapper condition={orderData}>
                    <ShippingInformation data={orderData} />
                </ConditionalWrapper>
            </div>
            <div className={classes.billingInformationContainer}>
                <ConditionalWrapper condition={orderData}>
                    <BillingInformation data={orderData} />
                </ConditionalWrapper>
            </div>
            {/* <div className={classes.shippingMethodContainer}>
            ...
            <Button
                ...
                onClick={() => {
                    ...
                    handleDownloadPdf(orderData?.No);
                }}
            >
                <Icon src={Printer} />
