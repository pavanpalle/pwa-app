...
const DetailGalleryItem = props => {
    ...
    const { storeConfig,remainingCount ,isSignedIn} = props;
    ...
    const priceSourceValue = priceSource?.value || priceSource||0.00;
    ...
    return (
        <div data-cy="GalleryItem-root" className={classes.root} ref={itemRef}>
            ...
            <div className={classes.productInfo}>
                ...
                <Price value={priceSourceValue} currencyCode={currencyCode} isSignedIn={isSignedIn}/>
            </div>
                <span>{sizeRange}</span>
            </div>
            <Link
